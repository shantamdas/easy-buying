...
public partial class booksAndMedia : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                SqlConnection con = new SqlConnection(str); SqlDataAdapter data = new SqlDataAdapter("select * from products where product_type='book' or product_type='midea'", con);
    ...
    protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        SqlDataAdapter data = new SqlDataAdapter("select * from products where product_type='book' or product_type='midea'", con);
