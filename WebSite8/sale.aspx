<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sale.aspx.cs" Inherits="offers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <p align="center">
        ...
        <asp:ImageButton ID="ImageButton2" runat="server" Height="40px" Width="140px" 
            ImageAlign="Middle" onclick="ImageButton2_Click" BorderStyle="Ridge" 
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        style="margin-right: 0px; margin-bottom: 0px;" BackColor="White" BorderColor="#999999" 
  ...
  <Columns>
   ...
   <asp:TemplateField HeaderText="Product Id">
        ...
        <ItemTemplate>
            <asp:Label ID="lbl_ptype" runat="server" Text='<% # Eval("product_type") %>'></asp:Label>
        </ItemTemplate>
        </asp:TemplateField>
        ...
        <ItemTemplate>
            <asp:Label ID="lbl_p_price" runat="server" Text='<% # Eval("actual_price") %>'></asp:Label>
        </ItemTemplate>
        </asp:TemplateField>

        <asp:TemplateField HeaderText="Offer Price">
        <ItemTemplate>
            <asp:Label ID="lbl_offer_price" runat="server" Text='<% # Eval("offer_price") %>'></asp:Label>
        </ItemTemplate>
        </asp:TemplateField>
