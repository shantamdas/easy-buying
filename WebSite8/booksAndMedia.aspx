<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="booksAndMedia.aspx.cs" Inherits="booksAndMedia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <p align="center">
        <asp:ImageButton ID="ImageButton2" runat="server" 
            onclick="ImageButton2_Click1" Height="40px" Width="140px" 
            BorderStyle="Ridge" ImageUrl="~/img/cart.png" />
        <br />
    </p>
</asp:Content>
