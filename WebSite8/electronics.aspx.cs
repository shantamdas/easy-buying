...
public partial class electronics : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                SqlConnection con = new SqlConnection(str); SqlDataAdapter data = new SqlDataAdapter("select * from products where product_type='mobile' or product_type='tab' or product_type='laptop'", con);
    ...
    protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        SqlDataAdapter data = new SqlDataAdapter("select * from products where product_type='mobile' or product_type='tab' or product_type='laptop'", con);
