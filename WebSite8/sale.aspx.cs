...
public partial class offers : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter data = new SqlDataAdapter("select * from sell", con);


            DataSet ds = new DataSet();
            data.Fill(ds, "sell");
            GridView1.DataSource = ds.Tables["sell"];
            GridView1.DataBind();
        }
    }
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            Label temp3 = (Label)GridView1.SelectedRow.FindControl("lbl_offer_price");
