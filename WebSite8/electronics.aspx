...
<asp:Content ID="Content2" runat="server" 
    ...
    <p align="center">
        <asp:Label ID="Label8" runat="server" 
            style="font-style: italic; font-weight: 700; color: #0000CC"></asp:Label>
    </p>
    <p align="center">
        <br />
        <asp:ImageButton ID="ImageButton2" runat="server" Height="40px" Width="134px" 
...
<asp:Content ID="Content3" runat="server" 
    ...
    <p align="left">
        <asp:Label ID="Label5" runat="server" BorderStyle="None" 
            style="text-decoration: underline; font-weight: 700; text-align: center" 
            Text="MY SELECTION : " Width="451px"></asp:Label>
